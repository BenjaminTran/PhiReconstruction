...
config.General.workArea = 'crab_dir/Phi_BDT_pPb_JL' + str(counter)
config.General.requestName = 'PhiBDT_2016pPb_JL' + str(counter)

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
#config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = os.path.expandvars('$CMSSW_BASE/src/PhiAnalyzer/PhiAnalyzer/python/phibdtapp_cfg.py')
...
config.Data.outputDatasetTag = 'PhiBDT_JL' + str(counter)
